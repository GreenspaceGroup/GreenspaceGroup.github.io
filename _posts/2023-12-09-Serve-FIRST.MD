...
# Civics lesson: Local Voluntarism

It starts with YOU and ONLY YOU. Serve FIRST.

Serve FIRST.

EXCLUSIVELY SERVE FIRST! There's no need to build any other thing does not primarily SERVE the objective of its constituents FIRST.  

Serve FIRST!!!  We are not running for office; we are not some caped crusader, but we really ARE just like Robin Hood and the merry souls of Sherwood Forest ... we are committed to the stewardship of our Creator's land -- that is why we save, invest, manage, tend and celebrate the land ... we put Aldo Leopold's LAND ETHIC into practice through our shared commitment to sustainable stewardship.  Just as is the case with planting majestic, high quality trees that we will never see -- we plant the saplings now because although those trees will thrive for hundreds of years after we are gone, someone must start the process NOW ... so we SERVE FIRST with Greenspace.Group to help others practice the land ethic, primarily with an eye to the future ... we intend to ensure that these greenspaces we start now are available for hundreds of years, for the citizens of the future whose lives are not yet even imagined. 

If humans want to be successful and find satisfaction in life, it is necessary for them to voluntarily do something that is about working diligently on some concrete vocation that they passionately LOVE every single day. It's all about SERVING the Creator ... SERVING a greater, larger more distant good.

Don't build somebody else's manipulative organization or some political campaign ... if you have enough to get by, stop worrying about assets or money ... render unto Caesar the things that are Caesar's ... let the dead bury their dead ... stay healthy, stay engaged with your Creator by BUILDING something that you love and will give away.  This is the civics lesson of local voluntarism.

# What is the Greenspace Group? What is different about the Greenspace Group?

Greenspace.Group is fundamentally an open source development organization that primarily *lives* on Github and Discord.
...
Greenspaces themselves are fundamentally NOT political; they are just open natural spaces that are for spending time outdoors, walking/hiking/exercising ... possibly alone and possibly with other people.  GreenspaceGroup is aggresssively NOT a political organization ... but it is an advocay organization.  As such, we do recognize the INTENSELY political nature of city councils, which tend to be populated by local business owners who need a politically favorable environment for their business ... we do recognize why homeowners associations form out of INTENSELY political reasons or the attempts of karens, gossips and snoops who can't mind their own business ... we do recognize why other county and state level agencies are politically formed and how the bureaucrats that populate thes jobs that seek additional rents [and higher salaries from greater responsibilities of controlling private property] as they license and restrict *pursuit of happiness* or the exercise of property rights ... POLITICAL POWER is FUNDAMENTALLY about the political process of hijacking the majoritary in order to direct the coercive force of the political lynch mobs to gain more power.  

GreenspaceGroup recognizes that advocating for a LAND ETHIC is fundamentally about the preservation of the roles for private citizens, small landholders and unaffiliated groups of citizens ... GreenspaceGroup serves it constitutents first in the exercise of their LEGAL and CONSTIUTIONAL rights to SHARE and responsibly do the stewardship which will allow future generations to continue to ENJOY local greenspaces. 

## How does the GreenspaceGroup, as a virtual organization practice its "SERVE FIRST" motto?

We are open source developers of community of people who love and enjoy our local greenspaces ... our people spend time, every single day, enjoying and preserving their local natural heritage.

This is not as easy as it sounds ... LOVING natural greenspaces takes commitment and eventually money and then a LOT MORE commitment ... fundamentally, it requires hard work and a disciplined commitment to both preserve a natural heritage resource, but also to improve it for those who will come after us in the next centuries. It's not just some hippie thing ... it's a dead serious disciplined, daily, ongoing commitment to the future of our communities and our country. 

## Why was Discord chosen as the primary communication platform for the GreenspaceGroup?

Social networks help us achieve our purposes ... there are good reasons why people go to the bother of mastering the use of things like Twitter, LinkedIn or Facebook ... 

It's PARTLY about communication and efficiently staying in touch ... almost everyone [who read this] will already have an email address and reasons for periodically checking that account.  As with that email address, social network platforms require constant curation and pruning.  That's particularly true in the case of something like Facebook because these platforms are only in existence because of ad revenues and the social networks tracking and analytics to target PASSIVE users.  Discord, in contrast to Facebook, is less about advertising and selling of tracking/analytics data of users -- Discord is more about selling subscriptions to ACTIVE users who are more engaged in developing their own more intensely focused networks of people with a passionate interest in a very particular topic. 

We can think about several facets in which Discord and Facebook are two very different platforms serve very different purposes. The PRIMARY difference is that Discord users will be much younger, much less PASSIVE, much less likely to just sit back and scroll through their content feed to entertain them as if the users were watching television and the postings were there to entainthem ...  but here are SOME of the OTHER key differences:

* Purpose: Discord is primarily used as a primary communication medium for active development communities, groups, teams that actively interact with one another over something like a game, project or product launch, while Facebook is a social networking platform that allows users to stalk and connect [or re-connect] with old friends, family and cousins, and other distant acquaintances who users might know from past associations or events but are not now actively engaged in developing new projects, ventures or products.

* Focus: Discord's main focus is on real-time text, voice, and video communication, interaction and doing things NOW, while Facebook's focus is on sharing updates, photos, and videos with a wider audience that may or may not particularly care all that much.

* Audience: Discord's user base is primarily made up of developers and younger under-40 communities with a strong focus on real-time communication and active back-and-forth collaboratio [as in online games or sw development], while Facebook's user base is much broader, but older and more passively-inclined with undefined set of interests or interests tied to the demographic segments they identified with four or five decade agos.

* Features: Discord offers user-developed, user-defined active communication features such as voice and video chat, lo fi music and screen sharing, and integrations with group-specific games and imaging services/video, while Facebook offers mega-mass-market features such as a FB-Engineering restricted news feed, groups, reels, and messaging that integrates with Instagram.

* Monetization: Discord generates revenue primarily through value-added subscription-based services, such as Discord Nitro which appeal to channel developers who use such services to provide a more customized vibe to their Discord servers, while Facebook generates revenue primarily through advertising and selling user analytics and tracking data to companies marketing to older, wealthier, more passive users.

* User interface: Discord's user interface is designed to be clean and simple, with a focus on ease of use and efficiency, while Facebook's user interface is more complex, with a wide range of features and options.

* Data privacy: Discord has faced some criticism for its data collection practices, but it has taken steps to improve its privacy controls and be more transparent about how it handles user data. Facebook, on the other hand, continues to face more and more privacy concerns and controversies over the years, while the Meta parent company of Facebook has implemented various measures designed to improve its revenue stream while staying a half-step ahead of the regulators who understand that Facebook is a master at protecting its revenue stream from older, more passive and wealthy users.

In summary, while both Discord and Facebook are extremely popular online platforms ... Facebook may have an order or two more in terms of users, but Discord has two or three hundred million users ... the two different entities have similiarities by they serve two entirely different purposes and cultivate a very different user demographic.

# Political Economics and the NEW Logic of Collective Action.

Local voluntarism is about the NEW logic of collective action.

It's not about rent-seeking like the OLD logic was.  The new logic of collective action is about how we assemble the material that going to go into the grinder in a manner that will be successful. Of course, NOW campaingns are primarily about new things like social media, analytics and efficiently tracking the success of content generation operations and optimizing asynchronous networks of opinion leaders. Yes, we still still see old school stuff like yardsigns and billboards, blizzards of mass mailers and the even more annoying carpetbombing of advertisements across different forms of media.  
...
1) ***SERVE the constituents FIRST!!!*** Strategically design the entire campaign to ***SERVE the constituents FIRST*** with a co-objective of SERVING those who are committed to their own campaingns of SERVING the constitutents FIRST ***BEFORE GETTING ELECTED TO OFFICE*** and using the power of incumbency to ***SERVE the constituents FIRST***.  If you want to help people who might be starting with next to nothing and you are actually SERIOUS about the discipline of making the country great again -- you need to help people bootstrap their multi-decade journey to greatness.  There's NO ROOM for the idiots reaching for the EASY BUTTON or clamoring for another stimulus package ... legit greatness is at minimum a lifelong journey ... and it takes a decade to put the most basic of basic [lkely-to-be-successful] skillsets together, ie we need to ditch the mentality of winning the lotto or using something like Covid lockdown to eat snacks and drink more alcohol. Fortunately we do have things to START with.  For starters, we will listify awesome open source app projects to be adapted by the campaign ... perhaps develop an indexed roadmap of key PLANNED *buddytrack* social AI-ified app refinements ... you might start with something like [a [Zulip based community](https://zulip.com/case-studies/rust/) or perhaps [a spin on Thunderbird's email/RSS reader](https://www.thunderbird.net/en-US/get-involved/)] ... the aim to ***SERVE the constituents FIRST!!!*** *RATHER than ask them to make financial contributions to fund the same-old SAME-OLD traditional [FAILED] approach to a campaign*.
...
19) How do you follow open source development, particularly in material focused on the scientific or mapping realm ... perhaps you can try to [keep up with the PyTorch blog](https://pytorch.org/blog/), follow the [best curated PyTorch list](https://github.com/ritchieng/the-incredible-pytorch) and personally [annotate your own personal AWESOME PyTorch list](https://github.com/BrunoScience/the-incredible-pytorch)? It's really about the COMMUNITY of open source devs that you can find around USEFUL technologies and perhaps, more to the point of this GROUP, it's about evangelizing, building and sustaining the community. ***Serve FIRST!*** *as we say* in everything...

20) In order to really learn how to use/extend Discord ... you can start by setting up a Discord server for your FUTURE campaign campaign or FUTURE organization ... don't invite a bunch of users, except for maybe one or two close friends, and worry about being embarrassed or getting everything right AT FIRST ... you will move in the direction of ***perfecting*** the use of Discord ... you will want to:

   A) Clearly define the purpose and scope of the server: Before creating your production-intent Discord server, it's important to wrap your head around Discord commuities work, so that you can more clearly define its purpose and scope ... but don't worry, it's all modifiable and you can change things as you progress. Think about the WHY of why you are bothering with this ... jot down some notes for yourself on exactly WHAT is the server for? Who is the target audience and how will you bring those people in? What kind of content will be shared?
   
   B) [GET STARTED as an Admin by just monkeying around with different server settings](https://discord.com/community/getting-started-as-a-server-admin): Discord offers various settings and templates that can help you customize your server to fit your needs. Consider settings such as server region, language, and category.
   
   C) As you get a *feel* for how the actual technology of Discord is administered, you will see that the magic of Discord is really about people. Administration is all about, staying out of the way, but firmly setting the appropriate welcoming vibe -- in other words, the most important parts of setting up your Discord server is probably about [determining “the law of the land.”](https://discord.com/community/developing-server-rules). Create and administer clear and concise rules: Establishing rules for your server will help maintain a positive and respectful environment for your community. 
   
   D) As the "sheriff in town," the admin has to make sure the rules are easy to understand and accessible by all members. The admin will need deputies or moderators; amongst those moderators, it is likely that some will develop into being alternative admins, but the roles are different. You will need to recruit and appoint capable, trusted moderators who *get* it. The admin cannot be available 24 hrs/day, so moderators play a crucial role in maintaining a positive and respectful environment on your server. Choose trusted individuals who share your organization's values and are familiar with your community guidelines.

   E) Develop helpful content [ESPECIALLY FOR NEW USERS] and EVANGELIZE in order to build the use of the different channels of the server effectively. Channels, which are like sub-headings, help organize conversations and keep your server somewhat tidy so that content and discussions are findable, especially by newly attracted users who are still unfamiliar with the group. Create channels for different topics, such as announcements, discussions, and support.

   F) Utilize the different roles and permissions for users of your server: Roles and permissions allow you to manage access to certain features and content within your server. ***Use*** roles to assign tasks and responsibilities to moderators and members. The most important parts of *setting up* your Discord server is probably about [determining “the law of the land.”](https://discord.com/community/developing-server-rules), but once that server is operational and people are participating in the community, it will be necessary to ENFORCE the "law of the land" ... and the approprite tone, will come from users, thought leaders, moderators and admings ... but prohibiting certain behaviors like trolling or deliberately making people uncomfortable, acting out, presenting offensive/controversial material for the sake of starting a controversy, or any kind of elitism or belittling newbs or snobbery ... is what it takes for a community to be successful ... if the trolls, snobs or confrontational controversy-mongers want to stir the pot, they can set up their own server. 

   G) Do not just wait for interactions to happen; provoke or at least NUDGE engagement to happen withing your community. A successful Discord server will relies upon more active than ordinary engagement from admins, moderators and established members ... it's really about erring on the side of encouraging different discussion, holding office hours and hosting events or virtual conferences and thanking/recognizing member contributions to foster a sense of community.
   
   H) Beyond just lurking, use automated observability tools to monitor, parse and *personally* address uncategorized issues promptly.  The "sheriff in town" or the sheriff's deputies have to keep an eye on server activity, and address any issues or concerns PROMPTLY. This will help maintain a positive environment and prevent misunderstandings from escalating.
   
   I) Regularly update, establish/keep a roadmap for updates and communicate changes.  The admins and moderators have to go out of their way to keep their community informed about updates, changes, and the roadmap of future plans. This *helps* to build trust and goes a long way to ensuring that everyone is on the same page ... but it is necessary to remember that some users will simply not use the server all that often and may be caught off gaurd in the changes, while they were absent, are too revolutionary ... rather than simply adding features, moving fast and breaking things, think instead about building TRUST while staying relevant ... it's unnecessary to have the edgiest community on the planet.
   
   J) Follow Discord's community guidelines and routinely go back and actually READ and review the terms of service. Make doubly sure that you are familiar with Discord's larger meta-server community guidelines and terms of service. Be sure that your server complies with these guidelines to avoid any issues with throttling or financial penalties or outright cancellations.
   
   K) Advance to the next level by just *really using* SEVERAL OTHER different Discord Servers a bit first in order to REALLY understand what's happening behind the scenes so  that you can [intelligently explore how the Discord code works](https://discord.com/developers/docs/intro). Be sure to join the Discord Developers Server to begin to map out some ideas to develop a next-phase strategy which includes the Discord API as well as various bots that seem to work especially well such as the [best calendar bot For Discord](https://sesh.fyi/).

21) How do greenspaces help people to stay more fit and especially mentally healthy, ie more engaged with their community and Nature.  How should anyone go about the process of trying stay fit? It's primarily a MENTAL exercise and matter of personal discipline ... but it can augmented with *BUDDYTRACKING* apps and local friends ... and apps can be further augmented with things like AI for just giving answers rather requiring the tedious processes of keeping up with ALL of the literature ... but, realistically, how is your campaign going to encourage health and fitness? Could you encourage people to join you on five mile hikes around town?  Beyond a physical exercise component, how about a nutritional component like a healthy chili/favorite soup potluck supper? 

22) How can can a campaign optimize it's Github engagement? Beyond just our commitgraphs ... can we encourage development in addition to forking of its repositories?  Can it use actions for build/review/test during dev ... what about copilot ... or discussions ... issues-driven CI/CD ... better commit messages and Git discipline... can it become the best Github advertisement for everything Github?  MOSTLY, can it use Github and forked repositories in affiliated campaigns to build a community of supporters and volunteers TO ELECT YOUR POLITICAL ALLIES TO OFFICE IN 2026?

23) How will you encourage VIRTUAL participations in your campaign ... Zulip, ZOOM, Discord ... what else? How about things like API data access connections between affliated campaingns ... how do you maximize REACH ... without requiring that people drive hundreds of miles for a convention or some other bogus pol meeting ... attracting and outreach to BUSY PEOPLE ... not just people who don't have anything better to do than to drive around ... is huge part of it, but you need to think with the end in mind, ie how do you close deals and monetize your campaign VIRTUALLY? The big question is: **How well does your stuff use other people's time or make them more productive/creative?**  Are you still one of those dinosaurs who just expects people to take the time to drive and spending time necessary attend your worthless waste-of-time event? Are you capable of thinking in terms of SERVING the stakeholders FIRST!!!

24) We probably want to move toward a world where we communicate and share ideas about what we are GOING TO build before we waste time actually building something in physical space ... the physical realm can *tread water* while we build the plans in the virtual realm ... this is nothing more than an application of the old "***Measure twice, cut once***" principle that's been with us for several thousand years of carpentry. How familiar are you with Universal Scene Description, [Blender 4.0 with Omniverse Connect](https://docs.omniverse.nvidia.com/connect/latest/blender/release-notes.html#usd-201-1), [Revit with Omniverse Connect](https://docs.omniverse.nvidia.com/connect/latest/revit.html) or maybe even [Autodesk Architecture, Engineering and Construction Collection](https://www.autodesk.com/collections/architecture-engineering-construction/overview?term=1&tab=subscription&plc=AECCOL) ... 

25) What's your familiarity with Tailscale and VPN workflows, DNS, Bind ... or for that matter really BASIC admin tools like Bash or [Powershell](https://learn.microsoft.com/en-us/training/modules/introduction-to-powershell/2-what-is-powershell) or Docker? Most people who work remotely are going to need to be relatively capable system administrators and cloud and container administrators [where baseline skills in DNS are a must] ... remote workers are probably going to be the key to the future of financially supporting the larger greenspace movement ... something like an active greenspace movement into the 22nd century will requires $, volunteer time and commitment from passionate stakeholders.

26) Have you used LIDAR scan data? What's your familiarity with pointcloud data or maybe HDR data from AI phones? It's really all about SMARTER communities ... where we can enjoy and USE real estate in a fully multiplexed fashion.  Of course, soil ecosystems are tremendously important, but what ELSE is going on beneath the surface? Have you ever located a natural gas or electrical utility line?  Do you know how this is done OR why it's still necessary to to use equipment to find utlity lines that should be digitally mapped by now?  Are you somewhat familiar with how people are using things like smartphone video to develop digital twin data models?

27) Of course, we want to spend a lot more time outside ... but the virtual realm is really about optimizing the experience of your time outdoors. What's your level of comfort with VR technologies.  Do you have a [Oculus Quest 2](https://www.amazon.com/Oculus-Quest-Advanced-All-One-Virtual/dp/B09B8DQ26F/) for martial arts, yoga, tai chi and flexibility training ... practicing martial arts moves, visualizing an opponent, shadow boxing strikes, kicks, and footwork ... maybe boxing games like “Thrill of the Fight” or “Creed: Rise to Glory” to provide a virtual sparring experience and help improve your reflexes and stamina ... fitness apps and guided yoga sessions with virtual instructors to focus on proper form and technique in immersive environments ... emphasizing balance, alignment, breathing exercises with Quest 2 to work on balance poses (e.g., tree pose, warrior pose) while maintaining proper form.... slow, flowing movement in old school martial arts like tai chi, using Quest 2 to practice fluid motions ... warm up/cool down with dynamic stretches in VR ... explore VR experiences that align with goals, practicing katas, holding a warrior pose, enhancing the mind-body connection.

28) What's your awareness of open source engineering, simulation and CAD tools, like [FreeCAD](https://en.wikipedia.org/wiki/FreeCAD) ... maybe you have seen Blender used in a high school STEM classroom?  Can you discuss the next level of development with might be about the constraints and parametric entities for actually converting a sketch into simulatable Universal Scene Description for CFM/FEA modeling or manufacturable dimensioned and toleranced 3D model with material properties. What's your kowledge of people who participate in the [open source CAD development cycle](https://wiki.freecad.org/FreeCAD_1.0_Development_Cycle) especially [OCCT development](https://dev.opencascade.org/) and the [collection of C++ libraries and resources](https://dev.opencascade.org/doc/overview/html/index.html#intro_overview) upon which [OpenCASCADE Technology](https://en.wikipedia.org/wiki/Open_Cascade_Technology) is based ... in the *larger* dev sense, this means following/understandings developments and future needs of things like the [KiCAD EDA tool](https://en.wikipedia.org/wiki/KiCad) which uses OCCT. 

29) What's your comfort level with [the infrastructure underneath] no-code software development such as [Fermyon Development](https://developer.fermyon.com/) for entrepreneurs and others developing their own dynamic landing pages ... or perhaps roll their own [WASM runtime](https://github.com/appcypher/awesome-wasm-runtimes) with something like [Docker+WasmEdge](https://www.docker.com/blog/build-share-run-webassembly-apps-docker/) or [WasmTime](https://docs.wasmtime.dev/) or a maybe a brand new riff on [IceCore](https://github.com/losfair/IceCore) or some other approach to building an [application container for WebAssembly](https://medium.com/webassembly/webassembly-docker-container-c0fce9a30fb1) ... the point is about a DYNAMIC economy based upon better and better and even better services for customers. We should be well past the bricks-and-mortar paradigm now, but people are still unaware of what can be done in this realm ... are you ready to build a campaign that demonstrates how much can be done with the this technology ... OR are you one of those who are going to send out mailers, make annoying robo calls and expect people to drive around looking at yardsigns or come to your worthless waste-of-time events?
...
31) What's your own personal business or professional career strategy for using Google Compute, or Microsoft Azure, Amazon Web Services, IBM Cloud, Oracle Cloud, Rackspace Cloud, Salesforce Cloud,  Alibaba Cloudor Hewlett Packard Enterprise (HPE) Cloud to get your work done more efficiently? How does AI make a professional or business owner like you more productive? Can you speak intelligently with the CEOs of these major platforms about what you like/dislike about their offering? Can you respond to their questions on government policy or government use of these resources.  Not just that ... what's your take on CoreWeave OR or Paperspace Gradient or Lambda Labs or VAST.ai or Nutanix or VMware or DigitalOcean or Linode or OVHcloud or Vultr or Scaleway or cloud.ca or UpCloud or Hetzner Cloud or Contabo OR ANY OTHER Cloud Functions-As-A-Service provider?
...
70) Maybe it's time to start curating an AWESOME list of data wranglers who write excellent blogs ... if someone has not already done something like that ... but it is well worth following people like [Simon Willison](https://simonwillison.net/0) the creator of [Datasette](https://datasette.io/), a tool for exploring and publishing data. Try the [demo of 33,000 global power plants](https://global-power-plants.datasettes.com/global-power-plants/global-power-plants)
